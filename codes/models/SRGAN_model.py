...
from compressai.zoo import mbt2018, bmshj2018_factorized
...
class SRGANModel(BaseModel):
    def __init__(self, opt):
        ...
        self.compressor = bmshj2018_factorized(quality=8, pretrained=True).eval()
    ...
    def feed_data(self, data, need_GT=True, is_val = False):
        shape_in = data['LQ'].shape
        #data['LQ'] = self.compressor.forward(data['LQ'])['x_hat']
        data['LQ'] = data['LQ'][:,:,:shape_in[2], :shape_in[3]]
